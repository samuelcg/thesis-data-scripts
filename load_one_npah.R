...
load_one_npah <- function(arg_time_stamp) {
  str_path_to_file <- paste("/Volumes/~samuelcg/thesis/Kamada-Kawai/raw-data/", arg_time_stamp, "/node_properties_annotation-highest.txt", sep="")
  ...
  # col_names <- c("domain_2_num_enriched_attributes", 
  #                "domain_3_num_enriched_attributes", 
  #                "domain_4_num_enriched_attributes", 
  #                "domain_5_num_enriched_attributes", 
  #                "domain_6_num_enriched_attributes", 
  #                "domain_7_num_enriched_attributes", 
  #                "domain_8_num_enriched_attributes", 
  #                "domain_9_num_enriched_attributes", 
  #                "domain_10_num_enriched_attributes",
  #                "domain_11_num_enriched_attributes",
  #                "domain_12_num_enriched_attributes", 
  #                "domain_13_num_enriched_attributes", 
  #                "domain_14_num_enriched_attributes", 
  #                "domain_15_num_enriched_attributes",
  #                "domain_16_num_enriched_attributes",
  #                "domain_17_num_enriched_attributes",
  #                "domain_18_num_enriched_attributes",
  #                "domain_19_num_enriched_attributes",
  #                "domain_20_num_enriched_attributes", 
  #                "domain_21_num_enriched_attributes",
  #                "domain_22_num_enriched_attributes")
